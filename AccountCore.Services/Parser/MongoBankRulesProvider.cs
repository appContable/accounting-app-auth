...
using System.Linq;
using AccountCore.Services.Parser.Interfaces;     // IBankRulesProvider, IBankCategoryRuleRepository
using AccountCore.DAL.Parser.Models;              // BankCategoryRule

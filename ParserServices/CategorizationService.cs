// ParserServices/CategorizationService.cs
using System;
using System.Linq;
...
using ParserDAL.Models;                 // ParseResult, AccountStatement, Transaction, RulePatternType, UserCategoryRule, BankCategoryRule
using ParserServices.Interfaces;        // ICategorizationService, IUserCategoryRuleRepository, IBankCategoryRuleRepository
...
namespace ParserServices
{
    public class CategorizationService : ICategorizationService
    {
        ...
        public async Task<UserCategoryRule> LearnAsync(ParserDTO.Parameters.LearnRuleRequest req, CancellationToken ct = default)
        {
